...
$(document).ready(function(e) {
	...
	let link1 = "IgnoranceIsBliss.html";
	let link2 = "HopelessRomantic.html";
	let link3 = '#';
	let link4 = '#';
	...
	function nextText(){
			...
			if (i == count-1) {
				...
				for(var j = 0; j < decision.length; j++) {
					...
					if (j == 1) {
						$('.conversationContainer .optionContainer').append('<a href="'+link+'" class="disableMe"><h3>Option '+n+'</h3><p>'+decision[j]+'</p></a>');
					} else {
